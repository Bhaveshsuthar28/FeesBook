  ...
  return (
    <section className="py-10 bg-gray-50">
      <div className="max-w-6xl mx-auto px-6">
        <div className="relative overflow-hidden bg-gradient-to-r from-[#4F46E5] to-indigo-700 rounded-3xl p-8 lg:p-12 shadow-xl shadow-indigo-100 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="shrink-0">
            <SignInButton mode="modal">
              <AuthLoginButton variant="solid" className="!bg-white !text-[#4F46E5] !border-white hover:!bg-indigo-50 hover:!text-indigo-700 shadow-lg" />
            </SignInButton>
          </div>
